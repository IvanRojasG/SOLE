      ...
      <section className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
        <div className="flex flex-col gap-3 border-b border-white/10 pb-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold text-white">Catalogo del box</h2>
          </div>
          <p className="text-sm text-[color:var(--color-text-muted)]">{localItems.length} items</p>
        </div>
            ...
            >
              <div>
                <div className="flex flex-wrap gap-2">
                  <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-white">
                    {categoryLabels[item.category]}
                  </span>
                  <span className="rounded-full border border-[color:var(--color-secondary)]/30 bg-[color:var(--color-secondary)]/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-[color:var(--color-secondary-soft)]">
              ...
              <div className="self-start rounded-full bg-white/10 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-white">
