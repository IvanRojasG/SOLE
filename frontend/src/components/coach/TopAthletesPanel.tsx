        ...
        <div className="mt-6 space-y-4">
          {athletes.map((athlete) => (
            <div
              ...
              className="flex items-center justify-between rounded-[1.5rem] border border-white/10 bg-[rgba(6,21,47,0.42)] p-4"
            >
              <div>
                <p className="text-sm font-semibold text-white">
                  {athlete.athleteName}
                </p>
                <p className="mt-1 text-xs tracking-[0.18em] text-[color:var(--color-text-muted)] uppercase">
                  {athlete.level}
                </p>
              </div>
              <div className="text-right">
                <p className="font-display text-4xl tracking-[0.08em] text-white uppercase">
                  {athlete.rank}
                </p>
                <p className="text-xs tracking-[0.18em] text-[color:var(--color-secondary-soft)] uppercase">
