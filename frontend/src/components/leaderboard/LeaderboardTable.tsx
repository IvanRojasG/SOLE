    ...
    <div className="hidden overflow-hidden rounded-[2rem] border border-slate-200 bg-white/95 shadow-[0_24px_70px_rgba(15,23,42,0.09)] lg:block">
      <table className="min-w-full">
        <thead className="bg-slate-950">
          <tr className="text-left text-xs uppercase tracking-[0.2em] text-white/70">
        ...
        <tbody>
          {entries.map((entry, index) => (
            ...
            >
              ...
              <td className="px-5 py-4 uppercase text-slate-500">{entry.level}</td>
              <td className="px-5 py-4 font-semibold text-slate-950">{entry.points}</td>
