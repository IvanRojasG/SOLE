...
from app.schemas.achievement import AchievementCreate, AchievementDetailedResponse, AchievementResponse
from app.schemas.common import MessageResponse
from app.services.achievements import approve_achievement, reject_achievement, submit_achievement
...
def my_achievements_detailed(
    ...
    return [
        AchievementDetailedResponse(
            ...
            points_awarded=challenges[achievement.challenge_id].points
            if achievement.status == "approved" and achievement.challenge_id in challenges
            else 0,
        )
...
def approve(
    ...
    approve_achievement(session, id)
